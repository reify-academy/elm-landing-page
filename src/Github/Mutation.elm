...
module Github.Mutation exposing (AcceptTopicSuggestionRequiredArguments, AddCommentRequiredArguments, AddProjectCardRequiredArguments, AddProjectColumnRequiredArguments, AddPullRequestReviewCommentRequiredArguments, AddPullRequestReviewRequiredArguments, AddReactionRequiredArguments, AddStarRequiredArguments, CreateBranchProtectionRuleRequiredArguments, CreateProjectRequiredArguments, DeclineTopicSuggestionRequiredArguments, DeleteBranchProtectionRuleRequiredArguments, DeleteProjectCardRequiredArguments, DeleteProjectColumnRequiredArguments, DeleteProjectRequiredArguments, DeletePullRequestReviewRequiredArguments, DismissPullRequestReviewRequiredArguments, LockLockableRequiredArguments, MoveProjectCardRequiredArguments, MoveProjectColumnRequiredArguments, RemoveOutsideCollaboratorRequiredArguments, RemoveReactionRequiredArguments, RemoveStarRequiredArguments, RequestReviewsRequiredArguments, SubmitPullRequestReviewRequiredArguments, UnlockLockableRequiredArguments, UpdateBranchProtectionRuleRequiredArguments, UpdateProjectCardRequiredArguments, UpdateProjectColumnRequiredArguments, UpdateProjectRequiredArguments, UpdatePullRequestReviewCommentRequiredArguments, UpdatePullRequestReviewRequiredArguments, UpdateSubscriptionRequiredArguments, UpdateTopicsRequiredArguments, acceptTopicSuggestion, addComment, addProjectCard, addProjectColumn, addPullRequestReview, addPullRequestReviewComment, addReaction, addStar, createBranchProtectionRule, createProject, declineTopicSuggestion, deleteBranchProtectionRule, deleteProject, deleteProjectCard, deleteProjectColumn, deletePullRequestReview, dismissPullRequestReview, lockLockable, moveProjectCard, moveProjectColumn, removeOutsideCollaborator, removeReaction, removeStar, requestReviews, submitPullRequestReview, unlockLockable, updateBranchProtectionRule, updateProject, updateProjectCard, updateProjectColumn, updatePullRequestReview, updatePullRequestReviewComment, updateSubscription, updateTopics)
