...
module Github.Object.MarketplaceCategory exposing (description, howItWorks, id, name, primaryListingCount, resourcePath, secondaryListingCount, slug, url)
...
id : SelectionSet Github.Scalar.Id Github.Object.MarketplaceCategory
id =
