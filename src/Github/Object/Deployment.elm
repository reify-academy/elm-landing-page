...
module Github.Object.Deployment exposing (StatusesOptionalArguments, commit, commitOid, createdAt, creator, databaseId, description, environment, id, latestStatus, payload, ref, repository, state, statuses, task, updatedAt)
...
-}
updatedAt : SelectionSet Github.Scalar.DateTime Github.Object.Deployment
updatedAt =
